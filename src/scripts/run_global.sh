...
do
    ...
    do
        ...
        do
            ...
            ./run_once_binary $exp_universe $k $exp_n test_file 10 $sorted >> $file
            echo >> $file

            echo "Binomial Heap:" >> $file
            ./run_once_binomial $exp_universe $k $exp_n test_file 10 $sorted >> $file
            echo >> $file

            echo "Fibonacci Heap:" >> $file
            ./run_once_fibonacci $exp_universe $k $exp_n test_file 10 $sorted >> $file
            echo >> $file
